    ...
    export default {
        ...
        methods: {
            ...
            handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
                ...
                axios({
                    url: "/api/icerikler2_image_editor",
                    method: "POST",
                    data: formData
                })
                    .then(result => {
            ...
            getResults(page = 1) {
                axios.get('/api/icerikler2?page=' + page)
                    .then(response => {
        ...
        created() {
            Fire.$on('searching',() => {
                ...
                axios.get('/api/findIcerikler2?q=' + query)
                    .then((data) => {
