    ...
    <div class="container-fluid">
        ...
        <div class="content-header mt-2" v-if="$gate.isAdmin()">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $trans[lang+'.pages']['pages'] }} - <small>{{ $trans[lang+'.pages']['mainpage'] }}</small></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $trans[lang+'.pages']['mainpage'] }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="summary">
                                <h3 class="text-center">{{ $trans[lang+'.pages']['mainpage_info'] }}</h3>
    ...
    export default {
        ...
        methods: {
            ...
            handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
                ...
                axios({
                    url: "/api/mainpage_image_editor",
                    method: "POST",
                    data: formData
                })
                    .then(result => {
                        let url = "/img/mainpage/thumbs/"+result.data.data; // Get url from response
            ...
            updateInfo(){
                ...
                this.form.put('/api/mainpage')
                    .then(()=>{
                        toast.fire({
                            type: 'success',
                            title: 'Main Page info changed successfully'
                        });
