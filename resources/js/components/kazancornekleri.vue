    ...
    <div class="container-fluid">
        ...
        <div class="content-header mt-2" v-if="$gate.isAdmin()">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $trans[lang+'.pages']['pages'] }} - <small>{{ $trans[lang+'.pages'][pagefullname] }}</small></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $trans[lang+'.pages'][pagefullname] }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="summary">
                                <h3 class="text-center">{{ $trans[lang+'.pages']['kazancornekleri_info'] }}</h3>

                                <div class="alert alert-info alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <strong>Model:</strong> App\Pagecreator<br>
                                    <strong>Usage:</strong> Pagecreator::findOrFail(1)
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{this.form.short_description6}}
                                        </td>
                                        <td>short_description6</td>
                                    </tr>
                                    <tr>
                                        <td>11</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}7:</strong></td>
                                        <td>
                                            {{this.form.short_description7}}
                                        </td>
                                        <td>short_description7</td>
                                    </tr>
                                    <tr>
                                        <td>12</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}8:</strong></td>
                                        <td>
                                            {{this.form.short_description8}}
                                        </td>
                                        <td>short_description8</td>
                                    </tr>
                                    <tr>
                                        <td>13</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}9:</strong></td>
                                        <td>
                                            {{this.form.short_description9}}
                                        </td>
                                        <td>short_description9</td>
                                    </tr>
                                    <tr>
                                        <td>14</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}10:</strong></td>
                                        <td>
                                            {{this.form.short_description10}}
                                        </td>
                                        <td>short_description10</td>
                                    </tr>
                                    <tr>
                                        <td>15</td>
                                        <td><strong>{{ $trans[lang+'.pages']['picture'] }}1:</strong></td>
                                        <td>
                                            <img v-if="form.picture1" :src="'\/img\/mainpage\/thumbs\/'+form.picture1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture2" :src="'\/img\/mainpage\/thumbs\/'+form.picture2">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture2</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture3" :src="'\/img\/mainpage\/thumbs\/'+form.picture3">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture3</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture4" :src="'\/img\/mainpage\/thumbs\/'+form.picture4">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture4</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture5" :src="'\/img\/mainpage\/thumbs\/'+form.picture5">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture5</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>24</td>
                                        <td><strong>{{ $trans[lang+'.pages']['detailed_content5'] }}:</strong></td>
                                        <td>-</td>
                                        <td>description5</td>
                                    </tr>
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <img v-if="form.picture1" :src="'\/img\/'+picturepath+'\/thumbs\/'+form.picture1">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture2" :src="'\/img\/'+picturepath+'\/thumbs\/'+form.picture2">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture3" :src="'\/img\/'+picturepath+'\/thumbs\/'+form.picture3">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture4" :src="'\/img\/'+picturepath+'\/thumbs\/'+form.picture4">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture5" :src="'\/img\/'+picturepath+'\/thumbs\/'+form.picture4">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                pagefullname:'kazancornekleripage',
                pagemainapi:'kazancornek',
                pageeditorapi:'kazancornek_image_editor',
                picturepath:'kazanc-oernekleri',
                imageapi1:'kazancornek_image1',
                imageapi2:'kazancornek_image2',
                imageapi3:'kazancornek_image3',
                imageapi4:'kazancornek_image4',
                imageapi5:'kazancornek_image5',
        ...
        methods: {
            ...
            handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
                ...
                axios({
                    url: '/api/'+this.pageeditorapi,
                    method: "POST",
                    data: formData
                })
                    .then(result => {
                        let url = '/img/'+this.picturepath+'/thumbs/'+result.data.data; // Get url from response
            ...
            updateInfo(){
                ...
                this.form.put('/api/'+this.pagemainapi)
                    .then(()=>{
                        toast.fire({
                            type: 'success',
        ...
        created() {
            axios.get('/api/'+this.pagemainapi)
