    ...
    <div class="container-fluid">
        ...
        <div class="content-header" v-if="$gate.isAdmin()">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $trans[lang+'.pages']['pages'] }} - <small>{{ $trans[lang+'.pages']['aboutme'] }}</small></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $trans[lang+'.pages']['aboutme'] }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="summary">
                                <h3 class="text-center">{{ $trans[lang+'.pages']['aboutmepage_info'] }}</h3>

                                <div class="alert alert-info alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <strong>Model:</strong> App\Pagecreator<br>
                                    <strong>Usage:</strong> Pagecreator::findOrFail(3)
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><strong>{{ $trans[lang+'.pages']['name'] }}:</strong></td>
                                        <td>
                                            {{this.form.name}}
                                        </td>
                                        <td>name</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td><strong>{{ $trans[lang+'.pages']['meta_title'] }}:</strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td><strong>{{ $trans[lang+'.pages']['meta_description'] }}:</strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td><strong>{{ $trans[lang+'.pages']['meta_keywords'] }}:</strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{this.form.short_description1}}
                                        </td>
                                        <td>short_description1</td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}2:</strong></td>
                                        <td>
                                            {{this.form.short_description2}}
                                        </td>
                                        <td>short_description2</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}3:</strong></td>
                                        <td>
                                            {{this.form.short_description3}}
                                        </td>
                                        <td>short_description3</td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}4:</strong></td>
                                        <td>
                                            {{this.form.short_description4}}
                                        </td>
                                        <td>short_description4</td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td><strong>{{ $trans[lang+'.pages']['short_description'] }}5:</strong></td>
                                        <td>
                                            {{this.form.short_description5}}
                                        </td>
                                        <td>short_description5</td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td><strong>{{ $trans[lang+'.pages']['picture'] }}1:</strong></td>
                                        <td>
                                            <img v-if="form.picture1" :src="'\/img\/whylea\/thumbs\/'+form.picture1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture2" :src="'\/img\/whylea\/thumbs\/'+form.picture2">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture2</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture3" :src="'\/img\/whylea\/thumbs\/'+form.picture3">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture3</td>
                                    </tr>
                                    <tr>
                                        <td>12</td>
                                        <td><strong>{{ $trans[lang+'.pages']['picture'] }}4:</strong></td>
                                        <td>
                                            <img v-if="form.picture4" :src="'\/img\/whylea\/thumbs\/'+form.picture4">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture4</td>
                                    </tr>
                                    <tr>
                                        <td>13</td>
                                        <td><strong>{{ $trans[lang+'.pages']['picture'] }}5:</strong></td>
                                        <td>
                                            <img v-if="form.picture5" :src="'\/img\/whylea\/thumbs\/'+form.picture5">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture5</td>
                                    </tr>
                                    <tr>
                                        <td>14</td>
                                        <td><strong>{{ $trans[lang+'.pages']['detailed_content1'] }}:</strong></td>
                                        <td>-</td>
                                        <td>description1</td>
                                    </tr>
                                    <tr>
                                        <td>15</td>
                                        <td><strong>{{ $trans[lang+'.pages']['detailed_content2'] }}:</strong></td>
                                        <td>-</td>
                                        <td>description2</td>
                                    </tr>
                                    <tr>
                                        <td>16</td>
                                        <td><strong>{{ $trans[lang+'.pages']['detailed_content3'] }}:</strong></td>
                                        <td>-</td>
                                        <td>description3</td>
                                    </tr>
                                    <tr>
                                        <td>16</td>
                                        <td><strong>{{ $trans[lang+'.pages']['detailed_content4'] }}:</strong></td>
                                        <td>-</td>
                                        <td>description4</td>
                                    </tr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <vue-dropzone  ref="myVueDropzone1" id="upload1" :options="imguploadconfig" @vdropzone-complete="picture1complete"></vue-dropzone>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <img v-if="form.picture1" :src="'\/img\/aboutme\/thumbs\/'+form.picture1">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <vue-dropzone  ref="myVueDropzone2" id="upload2" :options="imguploadconfig" @vdropzone-complete="picture2complete"></vue-dropzone>
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture2" :src="'\/img\/aboutme\/thumbs\/'+form.picture2">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <vue-dropzone  ref="myVueDropzone3" id="upload3" :options="imguploadconfig" @vdropzone-complete="picture3complete"></vue-dropzone>
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture3" :src="'\/img\/aboutme\/thumbs\/'+form.picture3">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <vue-dropzone  ref="myVueDropzone4" id="upload4" :options="imguploadconfig" @vdropzone-complete="picture4complete"></vue-dropzone>
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture4" :src="'\/img\/aboutme\/thumbs\/'+form.picture4">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <vue-dropzone  ref="myVueDropzone5" id="upload5" :options="imguploadconfig" @vdropzone-complete="picture5complete"></vue-dropzone>
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture5" :src="'\/img\/aboutme\/thumbs\/'+form.picture5">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="detailed">
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <label for="description1" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['detailed_content1'] }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="description2" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['detailed_content2'] }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="description3" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['detailed_content3'] }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="description4" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['detailed_content4'] }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="description5" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['detailed_content5'] }}</label>
    ...
    export default {
        ...
        methods: {
            ...
            handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
                ...
                axios({
                    url: "/api/aboutme_image_editor",
                    method: "POST",
                    data: formData
                })
                    .then(result => {
                        let url = "/img/aboutme/thumbs/"+result.data.data; // Get url from response
            ...
            updateInfo(){
                ...
                this.form.put('/api/aboutme')
                    .then(()=>{
                        toast.fire({
                            type: 'success',
                            title: 'Aboutme Page info changed successfully'
                        });
