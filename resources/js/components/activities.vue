    ...
    <div class="container-fluid">
        ...
        <div class="content-header" v-if="$gate.isAdmin()">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $trans[lang+'.pages']['pages'] }} - <small>{{ $trans[lang+'.main']['activities'] }}</small></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="shortdescription">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            <button @click.prevent="updateactivities" type="submit" class="btn btn-primary">{{ $trans[lang+'.pages']['update'] }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.photo3" :src="'\/img\/activities\/thumbs\/'+form.photo3">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.photo4" :src="'\/img\/activities\/thumbs\/'+form.photo4">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        created() {
            Fire.$on('searching',() => {
                ...
                axios.get('/api/findactivities?q=' + query)
                    .then((data) => {
