    ...
    <div class="container-fluid">
        ...
        <div class="content-header" v-if="$gate.isAdmin()">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $trans[lang+'.extras']['titlekazancornek'] }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $trans[lang+'.extras']['titlekazancornek'] }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-success">
                        <h3 class="card-title">{{ $trans[lang+'.extras']['titlekazancornek'] }}</h3>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover">
                            ...
                            <tr v-for="extras,index in extras.data" :key="extras.id">
                                <td>{{ index+1 }}</td>
                                <td>
                                    <img v-if="extras.picture" :src="'/img/kazanc-oernekleri/thumbs/' + extras.picture" >
    ...
    export default {
        data() {
            return {
                ...
                imguploadconfig: {
                    url: "/api/extraskazancornek_image",
                    headers: {
        ...
        methods: {
            ...
            getResults(page = 1) {
                axios.get('/api/extraskazancornek?page=' + page)
                    .then(response => {
            ...
            updateExtras() {
                ...
                this.form.put('/api/extraskazancornek/'+this.form.id)
                    .then(() => {
                        $('#addNew').modal('hide')
                        swal.fire(
                            'Updated!',
            ...
            createExtras() {
                this.$Progress.start();
                this.form.post('/api/extraskazancornek')
                    .then(({ data }) => {
            ...
            deleteExtras(id) {
                ...
                swal.fire({
                    ...
                    if(result.value) {
                        // send ajax request
                        this.form.delete('/api/extraskazancornek/'+id).then(()=>{
            ...
            loadExtras() {
                axios.get('/api/extraskazancornek').then(({ data})=> (this.extras=data));
            }
        },
        created() {
            Fire.$on('searching',() => {
                let query = this.$parent.search;
                axios.get('/api/findextraskazancornek?q=' + query)
                    .then((data) => {
