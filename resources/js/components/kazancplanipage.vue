    ...
    <div class="container-fluid">
        ...
        <div class="content-header mt-2" v-if="$gate.isAdmin()">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{ $trans[lang+'.pages']['pages'] }} - <small>{{ $trans[lang+'.pages']['kazancplanipage'] }}</small></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $trans[lang+'.pages']['kazancplanipage'] }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="summary">
                                <h3 class="text-center">{{ $trans[lang+'.pages']['kazancplanipage_info'] }}</h3>

                                <div class="alert alert-info alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <strong>Model:</strong> App\Pagecreator<br>
                                    <strong>Usage:</strong> Pagecreator::findOrFail(7)
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture1" :src="'\/img\/kazancplanipage\/thumbs\/'+form.picture1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture2" :src="'\/img\/kazancplanipage\/thumbs\/'+form.picture2">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture2</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture3" :src="'\/img\/kazancplanipage\/thumbs\/'+form.picture3">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture3</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture4" :src="'\/img\/kazancplanipage\/thumbs\/'+form.picture4">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture4</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <img v-if="form.picture5" :src="'\/img\/kazancplanipage\/thumbs\/'+form.picture5">
                                            <img v-else :src="'\/img\/nophoto.png'">
                                        </td>
                                        <td>picture5</td>
                                    </tr>
                            ...
                            <div class="tab-pane" id="shortdescription">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="short_description8" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['short_description'] }} 8:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="short_description9" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['short_description'] }} 9:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="short_description10" class="col-sm-2 control-label">{{ $trans[lang+'.pages']['short_description'] }} 10:</label>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture5" :src="'\/img\/kazancplanipage\/thumbs\/'+form.picture4">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
                ...
                axios({
                    url: "/api/kazancplanipage_image_editor",
                    method: "POST",
                    data: formData
                })
                    .then(result => {
                        let url = "/img/kazancplanipage/thumbs/"+result.data.data; // Get url from response
            ...
            updateInfo(){
                ...
                this.form.put('/api/kazancplanipage')
                    .then(()=>{
                        toast.fire({
                            type: 'success',
                            title: 'Kazanc Plani Page info changed successfully'
                        });
