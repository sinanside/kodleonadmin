    ...
    export default {
        ...
        data() {
            return {
                ...
                page:"erkenimplantyuklemesi",
                pagetitle:"Erken İmplant Yüklemesi",
                ...
                imguploadconfig1: {
                    url: "/api/erkenimplantyuklemesi_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/erkenimplantyuklemesi_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/erkenimplantyuklemesi_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/erkenimplantyuklemesi_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/erkenimplantyuklemesi_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
