    ...
    export default {
        ...
        data() {
            return {
                ...
                page:"erkenimplantyerlesimi",
                pagetitle:"Erken İmplant Yerleşimi",
                ...
                imguploadconfig1: {
                    url: "/api/erkenimplantyerlesimi_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/erkenimplantyerlesimi_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/erkenimplantyerlesimi_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/erkenimplantyerlesimi_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/erkenimplantyerlesimi_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
