    ...
    export default {
        ...
        data() {
            return {
                ...
                page:"hareketliprotezler",
                pagetitle:"Hareketli Protezler",
                ...
                imguploadconfig1: {
                    url: "/api/hareketliprotezler_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/hareketliprotezler_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/hareketliprotezler_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/hareketliprotezler_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/hareketliprotezler_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
