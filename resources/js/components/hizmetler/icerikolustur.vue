                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button  @click.prevent="backtolist" type="button" class="btn btn-warning"><i class="fas fa-undo"></i> Hizmet Listesine Dön </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <img v-if="form.picture1" :src="'\/img\/hizmetler\/thumbs\/'+form.picture1">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture2" :src="'\/img\/hizmetler\/thumbs\/'+form.photo2">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture3" :src="'\/img\/hizmetler\/thumbs\/'+form.picture3">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong>{{ $trans[lang+'.pages']['preview'] }}:</strong><br>
                                                <img v-if="form.picture5" :src="'\/img\/hizmetler\/thumbs\/'+form.picture5">
                                                <img v-else :src="'\/img\/nophoto.png'">
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                axios.get('/api/iceriklerbylang/'+this.form.language2+'/?page=' + page)
                    .then(response => {
            ...
            loadpostsbylang(id) {
                axios.get('/api/iceriklerbylang/'+id).then(({ data})=> (this.posts=data));
                axios.get('/api/hizmettursbylang2/'+id).then(({ data})=> (this.hizmetturs=data));
            },
            loadpostsbylang2(id) {
                axios.get('/api/iceriklerbylang2/'+id).then(({ data})=> (this.posts2=data));
            },
            ...
            loadHizmettur() {
                axios.get('/api/Allhizmettur').then(({ data})=> (this.hizmetturs=data));
            },
            loadLocalization() {
