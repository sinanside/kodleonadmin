    ...
    export default {
        ...
        data() {
            return {
                ...
                page:"prptedavisihizmeti",
                pagetitle:"PRP Tedavisi Hizmeti",
                ...
                imguploadconfig1: {
                    url: "/api/prptedavisihizmeti_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/prptedavisihizmeti_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/prptedavisihizmeti_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/prptedavisihizmeti_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/prptedavisihizmeti_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
