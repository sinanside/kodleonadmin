    ...
    export default {
        ...
        data() {
            return {
                ...
                page:"trassizsacekimi",
                pagetitle:"Traşsız Saç Ekimi",
                ...
                imguploadconfig1: {
                    url: "/api/trassizsacekimi_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/trassizsacekimi_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/trassizsacekimi_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/trassizsacekimi_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/trassizsacekimi_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
