    ...
    export default {
        ...
        data() {
            return {
                ...
                page:"sakalbiyikekimi",
                pagetitle:"Sakal Bıyık Ekimi",
                ...
                imguploadconfig1: {
                    url: "/api/sakalbiyikekimi_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/sakalbiyikekimi_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/sakalbiyikekimi_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/sakalbiyikekimi_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/sakalbiyikekimi_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
