    ...
    export default {
        ...
        data() {
            return {
                ...
                pagetitle:"Kadınlarda Saç Ekimi",
                ...
                imguploadconfig1: {
                    url: "/api/kadinlardasacekimi_image1",
                    headers: {
                ...
                imguploadconfig2: {
                    url: "/api/kadinlardasacekimi_image2",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig3: {
                    url: "/api/kadinlardasacekimi_image3",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig4: {
                    url: "/api/kadinlardasacekimi_image4",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
                ...
                imguploadconfig5: {
                    url: "/api/kadinlardasacekimi_image5",
                    headers: {
                        "X-CSRF-TOKEN": document.head.querySelector("[name=csrf-token]").content
                    },
                    maxFilesize: 5, // MB
