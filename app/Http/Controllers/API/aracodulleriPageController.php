...
class aracodulleriPageController extends Controller
{
    ...
    public function storeimage(Request $request)
    {
        ...
        if($request->file('file'))
        {
            ...
            $name = "arcodul_".time().'.'.$image->getClientOriginalExtension();

            $thumbnailImage = Images::make($image)->resize(200, 200)->save(public_path('/img/arac-oeduelleri/thumbs/' . $name));

            $watermark = Images::make(public_path('/img/watermark.png'));
            $Image = Images::make($image)->insert($watermark, 'bottom-right', 10, 10)->save(public_path('/img/arac-oeduelleri/' . $name));
