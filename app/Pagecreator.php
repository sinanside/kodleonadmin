...
class Pagecreator extends Model implements Sortable
{
    use Sluggable;
    ...
    protected $fillable = [
        ...
        'picture5', 'picture5_alt', 'picture6', 'picture6_alt', 'picture7', 'picture7_alt', 'picture8', 'picture8_alt', 'description1', 'description2', 'description3', 'description4', 'description5','special_code','language','active'
    ];
